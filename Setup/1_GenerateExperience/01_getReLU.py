...
with torch.no_grad():
    ...
    relu_neuron[0].bias = ppo_relu[0].bias

    sigmoid_neuron[0].weight = ppo_sigmoid[0].weight
    sigmoid_neuron[0].bias = ppo_sigmoid[0].bias


o = env.reset()
n1, n2 = relu_neuron(torch.FloatTensor(o)).detach().numpy()
print(n1)
print(n2)
print()

a1 = relu_neuron[0].weight[0].detach().numpy()
b1 = relu_neuron[0].bias[0].detach().numpy()
a2 = relu_neuron[0].weight[1].detach().numpy()
b2 = relu_neuron[0].bias[1].detach().numpy()
print(np.dot(a1, o) + b1)
print(np.dot(a2, o) + b2)
