...
def main():
    ...
    if parameters.oracle is not None:
        ...
        import numpy as np
        # load model
        oracle = TD3.load("../MountainCarContinuous/Oracle/" + parameters.oracle + '/model')
        # Load Trajectory
    ...
    # Constructors
    eval_function = globals()[parameters.eval_function](parameters.oracle, number_games, seed, "Pendulum-v0")
    ...
    if isinstance(algorithm, SimulatedAnnealing):
        ...
        OPERATIONS = [AssignAction, Ite, Gt0, Lt0, Num, Observation, Addition] #, Affine] #, Addition, Multiplication]
