...
class Node:
    ...
    def restore_original_production_rules():
        ...
        Addition.accepted_nodes = [Num.class_name(),
                                    ...
                                    Addition.class_name(),
                                    Multiplication.class_name()]
        Addition.accepted_types = [[ReLU.class_name()], [ReLU.class_name()]] #, Addition.accepted_nodes]]
        ...
        Gt0.accepted_nodes = [Observation.class_name(),
                                     ...
                                     Addition.class_name(),
                                     Multiplication.class_name()]
        Gt0.accepted_types = [[Addition.class_name()]] #[[ ReLU.class_name(), Observation.class_name(), Addition.class_name()]] #Affine.class_name(),[Gt0.accepted_nodes]

        Lt0.accepted_nodes = [Observation.class_name(),
                                 ReLU.class_name()]
                                 #Addition.class_name(),
                                 #Multiplication.class_name()]
        Lt0.accepted_types = [[Addition.class_name()]] #[[ ReLU.class_name(), Observation.class_name(), Addition.class_name()]]

        #Affine.accepted_nodes = [Num.class_name()]
        #Affine.accepted_types = [Affine.accepted_types, Affine.accepted_types, Affine.accepted_types, Affine.accepted_types, Affine.accepted_types]
