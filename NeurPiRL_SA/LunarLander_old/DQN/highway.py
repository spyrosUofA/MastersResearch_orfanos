...
from run_oracle import test
import os


def dqn(seed=1, n_episodes=2000, max_t=1000, eps_start=1.0, eps_end=0.005, eps_decay=0.995):
    ...
    agent = Agent(state_size=[5, 5], action_size=env.action_space.n, seed=seed)
