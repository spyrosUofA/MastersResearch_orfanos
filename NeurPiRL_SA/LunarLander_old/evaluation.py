...
class Evaluate():
    ...
    def __init__(self, oracle, nb_evaluations, seed, env_name='LunarLander-v2'):
        self.seed = seed
    ...
    def find_distance(self, p):
        ...
        actions_diff = spatial.distance.hamming(actions, self.actions)
...
class DAgger(Evaluate):
    ...
    def update_trajectory0(self, p):
        ...
        #print(len(self.actions) == len(self.inputs))
