...
DoubleProgram.accepted_nodes = set([Argmax.class_name(), Sum.class_name()])
...
ITE.accepted_nodes_bool = set(
    [LT.class_name(), In.class_name(), PlayerWinsAfterStopping.class_name(), AreThereNeutralsToPlay.class_name()])
ITE.accepted_nodes_block = set([ITE.class_name(), AssignActionToReturn.class_name()])
...
Argmax.accepted_nodes = set([Map.class_name()])
...
Node.accepted_types = [
    set([ITE.class_name(), Argmax.class_name(), Sum.class_name(), AssignActionToReturn.class_name()])]