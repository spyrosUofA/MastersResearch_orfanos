...
class BottomUpSearch():
    ...
    def synthesize(self, bound, operations, constant_values, observation_values, action_values, observations, actions, PiRL = False):
...
if __name__ == '__main__':
    ...
    p, num = synthesizer.synthesize(15, [Ite, Lt], [0.01, 0.22], [0, 1, 2, 3], [0, 1], observations, actions, PiRL=True)
    print(p.toString())
    print(p)
