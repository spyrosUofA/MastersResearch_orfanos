...
def main(seed, l1_actor, l2_actor):
    ...
    # train oracle
    model = DDPG('MlpPolicy', env, seed=seed, policy_kwargs=dict(net_arch=dict(qf=[256, 256], pi=pi_arch), activation_fn=torch.nn.ReLU), verbose=0)
...
if __name__ == "__main__":
    ...
    pool.starmap(main, zip(range(5, 10), repeat(32), repeat(0)))
